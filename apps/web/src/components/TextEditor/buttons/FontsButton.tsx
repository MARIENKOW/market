...
export default function FontsButton() {
    ...
    const activeFont = useTiptapState(
        (ctx) => (ctx.editor.getAttributes("textStyle")?.fontFamily as string | undefined) ?? "",
    );
    ...
    return (
        <Box display="inline-block" sx={{ minWidth: 80 }}>
            <StyledFormControl size="small" sx={{ display: "inline-block", minWidth: 80 }} fullWidth>
                <StyledInputLabel id="font-family-label">Font</StyledInputLabel>
                <StyledSelect
                ...
                >
                    <StyledMenuItem sx={{ fontFamily: "Inter" }} value="Inter">Inter</StyledMenuItem>
                    <StyledMenuItem sx={{ fontFamily: "Comic Sans MS, Comic Sans" }} value="Comic Sans">
                        Comic Sans
                    </StyledMenuItem>
                    <StyledMenuItem sx={{ fontFamily: "Monospace" }} value="Monospace">Monospace</StyledMenuItem>
                    <StyledMenuItem value="Cursive" sx={{ fontFamily: "cursive" }}>Cursive</StyledMenuItem>
