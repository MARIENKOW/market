...
export default function AdminRememberPasswordForm() {
    ...
    const onSubmit: CustomSubmitHandler<AdminForgotPasswordDtoOutput> = async (
        formValues,
        { setError },
    ) => {
        try {
    ...
    return (
        <SimpleForm<AdminForgotPasswordDtoInput>
            params={{
            ...
            onSubmit={onSubmit}
        >
            <FormFilledTextField<AdminForgotPasswordDtoInput>
